...
## Tips
Bruk klassenotatsblokka som ligger i Teams -> Utvikling. Der har du litt tips og triks for å repetere på det som trengs for å løse oppgaven. Bruk også hjelpemiddel som [(https://validator.w3.org/)[https://validator.w3.org/]] og Prettier [(Prettier)[https://marketplace.visualstudio.com/items?itemName=esbenp.prettier-vscode]]. 
